...
import {SKIPPING_FACTOR, GAS_LIMIT, OPTIMISM_COMPOUNDOR_JOB} from './utils/constants';
...
const compoundJob = new Contract(OPTIMISM_COMPOUNDOR_JOB, ICompoundKeep3rJobABI, txSigner);
